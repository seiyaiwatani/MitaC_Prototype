    ...
    <div className="page-root">
      ...
      <div className="page-body report-layout">
        ...
        <div className="split-col">
          ...
          <div style={{ flex: "1 1 0", minHeight: 0, overflowY: "auto", scrollbarGutter: "stable", padding: "6px 8px", borderBottom: "1px solid #e5e7eb" }}>
            {unfinished.length === 0 ? (
          ...
          <div style={{ flex: "1 1 0", minHeight: 0, overflowY: "auto", scrollbarGutter: "stable", padding: "6px 8px" }}>
            {favorites.length === 0 ? (
              <p style={{ fontSize: 14, color: "#9ca3af", textAlign: "center", padding: "8px 0" }}>なし</p>
            ) : (
              favorites.map((rc) => {
