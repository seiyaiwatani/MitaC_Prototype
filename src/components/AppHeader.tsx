  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", padding: "0 16px" }}>
        {showEndOfWork ? (
          <span style={{ fontSize: 14, fontWeight: 700, color: "#065f46", background: "#d1fae5", padding: "4px 12px", borderRadius: 99, display: "flex", alignItems: "center", gap: 6 }}>
            🏠 業務終了です。お疲れ様でした！
          </span>
        ) : hasEndReported ? (
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#fee2e2", padding: "4px 12px", borderRadius: 99 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "#991b1b", whiteSpace: "nowrap" }}>退勤がまだ行われていません</span>
            <Link href="/">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#fef3c7", padding: "4px 12px", borderRadius: 99 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "#92400e", whiteSpace: "nowrap" }}>始業報告が未提出です</span>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#ede9fe", padding: "4px 12px", borderRadius: 99 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "#4c1d95", whiteSpace: "nowrap" }}>残業報告が未提出です</span>
            <Link href="/report/overtime">
              <button style={{ background: "#7c3aed", color: "white", border: "none", borderRadius: 99, fontSize: 12, fontWeight: 700, padding: "2px 10px", cursor: "pointer" }}>
                残業報告する
              </button>
            </Link>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#ffedd5", padding: "4px 12px", borderRadius: 99 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "#9a3412", whiteSpace: "nowrap" }}>終業報告が未提出です</span>
      ...
      >
        {/* 管理者バッジ */}
        {role === "admin" && (
          <Link href="/admin" style={{ textDecoration: "none", flexShrink: 0, display: "flex", alignItems: "center" }}>
            <div style={{
              padding: "5px 16px", borderRadius: 99,
              display: "flex", alignItems: "center",
              background: "#1d4ed8", color: "white",
              fontSize: 14, fontWeight: 800, gap: 6,
            }}>
